...
public class DisplayDocument extends HttpServlet implements Serializable {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (id != null) {
                String query = "select document_content,document_name from documents_employment where id = " + id;
